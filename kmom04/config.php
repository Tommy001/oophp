...
$menu = array(
  ...
  'items' => array(
    ...
    'film' => array('text'=>'Filmdatabasen', 'url'=>'komplett.php', 'class'=>null), 
    'login' => array('text'=>'Inloggning', 'url'=>'movie_login.php', 'class'=>null), 
...
$menu = array(
  ...
  'items' => array(
    ...
    'login' => array(
      'text'  =>'Inloggning', 
      'url'   =>'movie_login.php',  
      'title' => 'Filmdatabasens inloggningssida',
    ),  
      ...
      'submenu' => array(
        ...
        'items' => array(
          ...
          'logout'  => array(
            ...
            'title' => 'Filmdatabasens utloggningssida'
          ),
       ),
*/       
...
$kabyssen['database']['dsn'] = 'mysql:host=localhost;dbname=toja14;'; 
