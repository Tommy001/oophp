...
<article class="readable">
   ...
   <p>
    ...
    <p>
        <strong>Extra.</strong> Jag har implementerat Slugify-funktionen och jag har återanvänt inloggningen från det förra kursmomentet. Jag kontrollerar om användaren är inloggad med hjälp av CUser etc. Man måste logga in för att göra tillägg, ändra, ta bort och lägga till innehåll och förstås för att återställa databasen. Sedan har jag lagt till filtret SmartyPants Typographer (skriv "typo" i filterfältet). Lade dessutom till lite kod så att det inte går att göra ändringar genom att skriva exempelvis 'edit.php?id=5' i adressraden, utan att vara inloggad. Och, just det... hela kursrepot är "pushat" till github. Nothing to commit, working directory clean.
    </p>
    <hr>
    ...
    <p>
        Min webbmall Kabyssen är nu fullstuvad med matnyttiga saker. Kursens syfte är ju bland annat att lära ut objektorienterad webbprogrammering (man lär sig mycket annat också). Jag saknar en modul för uppladdning av filer, men det går ju att råda bot på. Jag kommer definitivt att ha användning för CImage, CUser, CDatabase och flera stycken till i det kommande projektet.
    <p>
