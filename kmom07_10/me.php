...
<h1>Om mig</h1>
  ...
  <p>När det gäller hemsidor har jag fuskat med HTML, CSS, PHP och MySQL på egen hand i något år och har nu avslutat "oophp" som är den andra delen i kurspaketet "Databaser, HTML, CSS, JavaScript och PHP". Jag inser att det är bättre att lära sig hantverket från grunden och i rätt ordning och det här kurspaketet passar ju som hand i handske.
